...
{(669) 268-8661 $\bullet$ arunesh@picolo.network}
...
\header{Work Experience}
    ...
    \begin{itemize}
         \item [] {\it Initial work on Safely as a personaly safety assistant for teens and women.}
         \item [] {\it Using the BERT and AlBERT model for advanced Question Answering.}
    \end{itemize}
