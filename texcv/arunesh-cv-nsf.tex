...
{(669) 268-8661 $\bullet$ aruneshm@kynamics.com}
...
\header{Work Experience}
    {\bf Member, Kynamics LLC}\hfill{\it Jun 2018 - date}
    \begin{itemize}
         \item [] {\it Safely:} Initial work on Safely as a personaly safety assistant for teens and women.
         \item [] {\it Factor:} Using the BERT and AlBERT model for advanced Question Answering.
    \end{itemize}

    {\bf Principal Engineer, Picolo Labs Inc}\hfill{\it Feb 2017 - May 2020}
    \begin{itemize}
