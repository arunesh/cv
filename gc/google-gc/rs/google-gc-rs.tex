...
%Probabilistic Spam detection while preserving User Anonymity.
%Scraping Resistant Prefetching methods for location anchor points.
%- Protection against database scraping.
%- how location information is uniquely sensitive and privacy is a bigger concern. Location can be derived using wifi/cellular/
%signals and my expertise on wireless networking technologies combined with my knowledge of computer security and privacy
%gives me the right skills to attack this problem.
