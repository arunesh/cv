...
{  655 South Fair Oaks, Apt O-311, Sunnyvale, CA 94086.}
...
{\bf Jan 2008 - date}
    \begin{itemize}
	 ...
	 launched with Google's Toolbar for Microsoft's Internet Explorer.
	 My current algorithms serve about 50 million
	 location queries per day distributed over laptops and mobile phones.
	 All of these offerings are free to Google's users and
...
{\bf Issued:}
    \begin{itemize}
       \item [] [1] Method for performing authenticated handover in a WLAN. \# 7,236,477. 2007.
       \item [] [2] Method for fast roaming in a wireless network. \# 7,263,357. 2007.
       \item [] [3] Algorithms for Fast Handoffs in a WLAN. \# 7,421,268. 2007.
       \item [] [4] Probing method for fast handoff in WLAN. \# 7,400,604. 2008.
       \item [] [5] Methods and apparatus for secure, portable, wireless and multi-hop data networking.\# 7,634,230. 2009.
     \end{itemize}

{\bf Pending:}
    \begin{itemize}
%    \renewcommand{\labelitemi}{$\circ$}
       \item [] [3] Novel scanning algorithm for fast handoff in WLAN. 2006 (UMaryland).
       \item [] [4] Method for performing handoff context-transfer in wireless
       network. 2005 (UMaryland).
       \item [] [5] Method and System for client-driven channel management in
       wireless communication networks. 2007 (UWMadison).
       ...
       channels. 2007 (UWMadison).
       \item [] [7] Wireless Data Transceiver Varying Data Transmission Rates Within A Packet, 2008 (UWMadison).
       \item [] [8] Provisions for a Wireless Network with Improved Energy Efficiency, 2009 (UWMadison).
       \item [] [9] Algorithms and Techniques for Interference Mitigation and Policy Enforcement in Multi-AP Wireless LANs Through Centralized Scheduling (CENTAUR), 2009 (UWMadison).
       \item [] [10] Derivation of Minimum Coverage of Cellular Sectors with Cellular-Site Spatial Density and Application Specific Data, 2008 (Google).
       \item [] [11] Wifi-based Location Approximation, 2008 (Google).
       \item [] [12] Method and Apparatus for a Server-less Localization System, 2009 (Google).
       \item [] [13] Social Coupons: Creating a Collaborative Shopping Experience, 2009 (Google).
       \item [] [14] Algorithms and Approaches for discovering and ranking Wifi-hotspots, 2009 (Google).
       \item [] [15] Geo-Annotation of Web Objects and their Applications, 2009 (Google). 
       \item [] [16] MeetMe: Real-Time Route/Directions Sharing And Group Tracking, 2009 (Google).
       \item [] [17] Determining Geographic Location of Network Hosts, 2009 (Google).
       \item [] [18] System and Method for Optimizing Location Computation at Mobile clients, 2009 (Google).
    \end{itemize}
